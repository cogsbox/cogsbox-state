import { __exports as r } from "../../../_virtual/react.production.js";
/**
 * @license React
...
function Q() {
  ...
  function g(e, t, n) {
    var o, u = {}, c = null, s = null;
    if (t != null) for (o in t.ref !== void 0 && (s = t.ref), t.key !== void 0 && (c = "" + t.key), t) x.call(t, o) && !O.hasOwnProperty(o) && (u[o] = t[o]);
  ...
  function d(e, t, n, o, u) {
    ...
    if (s) return s = e, u = u(s), e = o === "" ? "." + E(s, 0) : o, j(u) ? (n = "", e != null && (n = e.replace(P, "$&/") + "/"), d(u, t, n, "", function(a) {
      return a;
    })) : u != null && (R(u) && (u = H(u, n + (!u.key || s && s.key === u.key ? "" : ("" + u.key).replace(P, "$&/") + "/") + e)), t.push(u)), 1;
    if (s = 0, o = o === "" ? "." : o + ":", j(e)) for (var f = 0; f < e.length; f++) {
      c = e[f];
      var i = o + E(c, f);
      s += d(c, t, n, i, u);
    }
    else if (i = B(e), typeof i == "function") for (e = i.call(e), f = 0; !(c = e.next()).done; ) c = c.value, i = o + E(c, f++), s += d(c, t, n, i, u);
  ...
  return r.Children = { map: _, forEach: function(e, t, n) {
    ...
    var o = $({}, e.props), u = e.key, c = e.ref, s = e._owner;
    if (t != null) {
      if (t.ref !== void 0 && (c = t.ref, s = S.current), t.key !== void 0 && (u = "" + t.key), e.type && e.type.defaultProps) var f = e.type.defaultProps;
      for (i in t) x.call(t, i) && !O.hasOwnProperty(i) && (o[i] = t[i] === void 0 && f !== void 0 ? f[i] : t[i]);
    }
